...
export default function HeroCard() {
  return (
    ...
    >
      ...
      <div className="relative mb-8">
        ...
        >
          <div className="w-full h-full rounded-full bg-surface-container-lowest flex items-center justify-center">
            <span className="text-2xl text-white tracking-widest font-headline font-extrabold">
              KC
            </span>
          </div>
        </div>
      ...
      {/* Name */}
      <h1 className="text-[38px] leading-[1.1] text-white mb-2 font-headline font-extrabold">
        {profile.name}
      </h1>

      {/* Role — gradient text */}
      <h2
        className="text-2xl font-bold mb-6 bg-clip-text font-headline"
        style={{
